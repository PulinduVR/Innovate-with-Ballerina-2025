            ...
            <div className="foreground-content">
                {/* <div className="full-screen-container">
                    ...
                    <div className="inner-container">
                        <motion.div initial={{ opacity: 0 }} className={`card card1`} animate={visibleCard >= 1 ? controls : { opacity: 0 }}>
                            <TimeLineCard1 text={"Opening Registration"} month={"SEPTEMBER"} day={"01"} />
                        </motion.div>
                        <motion.div initial={{ opacity: 0 }} className={`card card2`} animate={visibleCard >= 2 ? controls : { opacity: 0 }}>
                            <TimeLineCard2 text={"Awareness Session"} month={"SEPTEMBER"} day={"16"} />
                        </motion.div>
                ...
                <div className='paraSec'>
                    ...
                    <div className="paraSec-sub">
                        ...
                        <p className="para">
                            Join the "Innovate with Ballerina" competition to<br /> showcase your coding skills and creativity!<br /> Compete for exciting rewards and gain invaluable<br /> experience. Register now and embark on a journey<br /> of learning and discovery. Good luck, and we look<br /> forward to your incredible projects!
                        </p>
                        
                        <img src='./register-today.png' alt='Ballerina Computer' className='register-image'/>
                        <img src='./register-today-claws.png' alt= "Claws" className='register-claws'/>
